...
class WordEmbeddings(TokenEmbeddings):
    ...
    def __init__(
        ...
        self.embedding = bnb.nn.StableEmbedding.from_pretrained(torch.FloatTensor(vectors), freeze=not fine_tune)
    ...
    def __setstate__(self, state: Dict[str, Any]):
        ...
        if "precomputed_word_embeddings" in state:
            ...
            embedding =  bnb.nn.StableEmbedding.from_pretrained(torch.FloatTensor(vectors), freeze=not state["fine_tune"])
...
class CharacterEmbeddings(TokenEmbeddings):
    ...
    def __init__(
        ...
        self.char_embedding = bnb.nn.StableEmbedding(len(self.char_dictionary.item2idx), self.char_embedding_dim)
...
class OneHotEmbeddings(TokenEmbeddings):
    ...
    def __init__(
        ...
        # model architecture
        self.embedding_layer = bnb.nn.StableEmbedding(len(self.vocab_dictionary), self.__embedding_length)
...
class HashEmbeddings(TokenEmbeddings):
    ...
    def __init__(self, num_embeddings: int = 1000, embedding_length: int = 300, hash_method="md5") -> None:
        ...
        # model architecture
        self.embedding_layer = bnb.nn.StableEmbedding(self.__num_embeddings, self.__embedding_length)
